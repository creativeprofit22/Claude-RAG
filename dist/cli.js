...
import { query, search, addDocument, listDocuments, deleteDocument, isReady } from './index.js';
import { logger } from './utils/logger.js';
const COMMANDS = ['add', 'search', 'query', 'list', 'delete', 'status', 'help'];
function printUsage() {
    console.log(`
 ...
 */
async function handleSearch(question, options) {
    console.error(`\nSearching: "${question}"\n`);
