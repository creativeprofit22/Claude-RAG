...
export function Drawer({ title, isOpen, onToggle, children, className = '', }) {
    ...
    const animateOpen = useCallback(() => {
        if (!innerRef.current || !pullRef.current)
            return;
    ...
    return (_jsxs("div", { ref: drawerRef, className: `catalog-drawer ${isOpen ? 'open' : ''} ${className}`, "data-animating": isAnimating, children: [_jsxs("div", { className: "drawer-face", onClick: handleClick, children: [_jsx("div", { className: "drawer-label-holder", children: _jsx("div", { className: "drawer-label", children: _jsx("span", { className: "drawer-label-text", children: title }) }) }), _jsx("div", { ref: pullRef, className: "drawer-pull", children: _jsx("div", { className: "drawer-pull-inner" }) })] }), _jsx("div", { ref: innerRef, className: "drawer-inner", children: _jsxs("div", { className: "drawer-interior", children: [_jsxs("div", { className: "drawer-bottom", children: [_jsx("div", { className: "drawer-rail left" }), _jsx("div", { className: "drawer-rail right" })] }), _jsx("div", { className: "drawer-cards", children: children })] }) })] }));
}
