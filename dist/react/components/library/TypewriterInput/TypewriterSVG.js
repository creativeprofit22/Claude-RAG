...
// ============================================
export const TypewriterSVG = memo(forwardRef(({ width = '100%', height = 'auto', className = '', showKeyboard = true }, ref) => {
