...
export function usePreloaderState(options = {}) {
    const { forceShow = false } = options;
    // Initialize state from storage/media query
    const [hasSeenBefore, setHasSeenBefore] = useState(() => getHasSeenPreloader());
...
//# sourceMappingURL=usePreloaderState.js.map