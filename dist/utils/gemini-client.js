...
export function getGeminiClient() {
    ...
    if (!apiKey) {
        throw new Error('GOOGLE_AI_API_KEY environment variable is required. Get one at https://aistudio.google.com/apikey');
    }
 ...
 */
export async function getGeminiClientAsync() {
    if (genaiClient) {
        return genaiClient;
    }
