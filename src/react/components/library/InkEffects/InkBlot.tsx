...
export function InkBlot({
  ...
  return (
    <div
      ref={containerRef}
      className={`ink-blot ${isRecovering ? 'ink-blot--recovering' : ''} ${className}`}
      role="alert"
      aria-live="assertive"
    >
      {/* Main ink blot */}
      <div ref={blobRef} className="ink-blot__blob" aria-hidden="true">
        {/* Splatter drops */}
        <div className="ink-blot__splatter" />
        <div className="ink-blot__splatter" />
        <div className="ink-blot__splatter" />
      </div>

      {/* Blotting paper overlay (visible during recovery) */}
      <div className="ink-blot__blotter" aria-hidden="true" />

      {/* Error message */}
      {message && (
        <p className="ink-blot__message">
          {message}
        </p>
      )}
