...
export const CYBERPUNK_COLORS = {
  primary: [0, 1, 1] as [number, number, number],         // #00ffff - Cyan
  accent: [1, 0, 0.5] as [number, number, number],        // #ff0080 - Magenta
  bgDeep: [0.039, 0.039, 0.071] as [number, number, number], // #0a0a12
  bgSurface: [0.071, 0.071, 0.122] as [number, number, number], // #12121f
  textPrimary: [0.878, 0.878, 1] as [number, number, number], // #e0e0ff
};
