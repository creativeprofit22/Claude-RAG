 ...
 * ```
 */
export function SkinAwareChart({
  option,
  style,
  className = '',
  loading = false,
  ...
  const themedOption = useMemo(() => {
    ...
    return {
      ...
      xAxis: {
        ...
        axisLabel: {
          ...((xAxis as Record<string, unknown>)?.axisLabel as Record<string, unknown> ?? {}),
      ...
      yAxis: {
        ...
        axisLabel: {
          ...((yAxis as Record<string, unknown>)?.axisLabel as Record<string, unknown> ?? {}),
          color: theme.textStyle.color
        },
      },
